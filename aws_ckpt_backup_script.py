...
subprocess.run(["aws", "s3", "cp", f"/fsx/itsleonwu/audiolm-pytorch-training/sbatch_job.sh", f"s3://{bucket_prefix}/{s3_folder}/sbatch_job.sh", "--profile", "laion-stability-my-s3-bucket"])
