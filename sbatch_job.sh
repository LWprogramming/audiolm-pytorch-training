...
if [[ -f audiolm_pytorch_demo_laion_snapshot_$SLURM_JOB_ID.py && -f sbatch_script_$SLURM_JOB_ID.sh ]]; then
    ...
    cp audiolm_pytorch_demo_laion_snapshot.py audiolm_pytorch_demo_laion_snapshot_$SLURM_JOB_ID.py
