...
def train(profiler=None):
    ...
    if args.train_or_eval == "evaluate":
        ...
        assert semantic_transformer.device == coarse_transformer.device and coarse_transformer.device == fine_transformer.device and semantic_transformer.device == 0, f"all three transformers should be on the same device and there should only be 1 device. instead got semantic on {semantic_transformer.device}, coarse on {coarse_transformer.device}, and fine on {fine_transformer.device}"
